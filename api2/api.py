...
def submit():
    ...
    details = file_path_details.getLastInsertedDocument.find({})
    uri = details['csvURI']
...
def getVisualization():
    details = file_details.getLastInsertedDocument.find({})
...
def sendScatterVisualization():
    var_details = variable_details.getLastInsertedDocument.find({})
    path_details = file_path_details.getLastInsertedDocument.find({})
